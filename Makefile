...
# the name and directory of the outputed .a archive file of all non executable source
# name defaults to the name of the Makefile's parent directory
# path defaults to BINDIR
STATICARCHIVE:=
STATICARCHIVEDIR:=
# the name and directory of the outputed .so shared library
